    ...
    <div className="action-buttons-row">
      ...
      <button className="action-tile-btn" onClick={onScanMeal}>
        <div className="action-icon-circle action-icon-green">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1F4B3F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <button className="action-tile-btn" onClick={onVoiceLog}>
        <div className="action-icon-circle action-icon-orange">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#A8571E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <button className="action-tile-btn" onClick={onManualEntry}>
        <div className="action-icon-circle action-icon-neutral">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#6E6760" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
